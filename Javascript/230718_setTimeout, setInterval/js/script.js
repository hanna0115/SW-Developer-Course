...
// n초 후가 아니라 n초마다 코드를 실행하고 싶다면 => setInterval()
// setInterval(function(){}, 5000)

// setTimeout(): n초 후 코드를 실행하는 함수
// setInterval(): n초마다 코드를 실행하는 함수


// Hex(16진수) 코드로 랜덤 컬러 변경
// 16진수 hex값 앞에 css에서는 #을 붙여서 사용
...
// Math.random() : 0이상 1미만의 부동 소수점 난수를 생성
// Math.round : 소수점 이하의 값을 반올림해서 정수로 변환
// (max - min + 1) 최소, 최대값 범위 내에서 랜덤한 값을 얻기 위한 코드
// (255 - 0 + 1) + 0 = 256
// 1을 더해주지 않으면 255 미만이기 때문에 254까지만 랜덤수를 가져옴.
// (20 - 10 + 1) + 10 = 21 -> 20까지 랜덤수 가져옴.
