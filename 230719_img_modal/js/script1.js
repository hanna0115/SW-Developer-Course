// .open-btn 클릭 시 .modal-box fadeIn()
...
// .modal-list img를 클릭했을 때 그 클릭된 이미지의 src, alt 값을 가져온다.
// 속성값을 가져올 때는 attr이라는 메서드를 사용
$('.modal-list img').click(function(){
  let 이미지경로 = $(this).attr('src');
  let 대체텍스트 = $(this).attr('alt');

  // 클릭된 요소의 src, alt값이 담긴 변수
  // .img-modal-wrapper img src, alt 값으로 넣어주다.
...
// .img-madal-btn click시 .img-modal-box, .overlay를 fadeOut()
$('.img-madal-btn').click(function(){
